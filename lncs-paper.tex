...
\paragraph{}
\textit{Software Defined Networking} (SDN) é uma arquitetura de redes emergente onde o controlo da rede é desassociado do plano de dados e é diretamente programável\cite{fundation2012software}
